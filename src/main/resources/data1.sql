-- h2 database will load this sql file
-- it searched for the table and the table product is created later
-- and it tries to insert the data when table is not yet created. 

-- to solve above issue we need to delay the process of initialisation, we do it in applcation.properties
